    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_formats', models.ManyToManyField(related_name='inputs', to='classes.DataFormat')),
                ('output_formats', models.ManyToManyField(related_name='outputs', to='classes.DataFormat')),
        ...
        migrations.CreateModel(
            name='Academic',
            fields=[
                ('marketsegment_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='classes.marketsegment')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
