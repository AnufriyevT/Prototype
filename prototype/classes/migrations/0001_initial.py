# Generated by Django 3.1.7 on 2021-04-11 16:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('academic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='classes.academic')),
            ],
        ),
        migrations.CreateModel(
            name='Producer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complementary_products', models.ManyToManyField(related_name='_product_complementary_products_+', to='classes.Product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('standard', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='classes.standardprice')),
                ('volume', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='classes.volumeprice')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.AddField(
            model_name='pricing',
            name='retail',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='classes.retail'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='academic',
            name='standard',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='classes.standardprice'),
        ),
        migrations.AddField(
            model_name='academic',
            name='volume',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='classes.volumeprice'),
        ),
    ]
